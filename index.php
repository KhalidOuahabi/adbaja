...
<head>
  ...
  <title>adbaja - Service informatique</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center">
      ...
      <a href="#hero" class="logo me-auto">
        <img src="./assets/img/Logo_adbaja.png" alt="">
      </a>
      <!--h1 class="logo me-auto"><a href="index.html">adbaja</a></h1-->
      ...
      <div class="social-links">
        <a href="tel:+212661120332" class="telephone"><i class="bi bi-telephone-fill"></i></a>
        <a href="mailto:contact@adbaja.com" class="at"><i class="bi bi-envelope-fill"></i></a>
        <a href="https://www.linkedin.com/company/adbaja" class="linkedin"><i class="bi bi-linkedin"></i></a>
      </div>
    ...
    <div class="container d-flex h-100">
      <div class="row justify-content-center align-self-center" data-aos="fade-up">
        <div class="col-lg-6 intro-info order-lg-first order-last" data-aos="zoom-in" data-aos-delay="100">
          <h2>Effective Solutions<br>for Your <span>Business!</span></h2>
          <div>
  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-md-6">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">
              <h2>About Us</h2>
              <h3></h3>
              <p>ADBAJA is a company that is specialized in the IT field.</p>
              <p>Founded in 2011 by two brothers working on their branding since then nowaday adbaja Provide :</p>
              <ul>
                <li><i class="bi bi-check-circle"></i> Supplying computer hardware (Server, Computer, printers, scanners, security camera, etc.) also office equipment.</li>
                <li><i class="bi bi-check-circle"></i> Providing maintenance services for computer equipment and repair them as well as electrical issues.</li>
                <li><i class="bi bi-check-circle"></i> Digitalize companies by developing an internal web application that manages all different areas and creating Websites that represent the services that our clients offer 
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-out">
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" data-toggle="modal" data-target="#call_to_action">Call To Action</a>
          </div>
        </div>
      </div>
    ...
    <div id="call_to_action" class="modal-dialog modal-dialog-centered">
      ... div contact us 
    </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="clients-slider swiper-container">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/img/clients/logo-omrane.png" class="img-fluid" alt="al omrane"></div>
            <div class="swiper-slide"><img src="assets/img/clients/logo_TFZ.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/logo_tmpa.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/logo_CoverCar.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/Logo_INDUTEXA.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/Logo_Aptiv.svg.png" class="img-fluid" alt=""></div>
  ...
  <footer id="footer" class="section-bg">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="footer-links">
                  <h4>Contact Us</h4>
                  <p>
                    42 Jean-Jacques Rousseau<br>
                    Maroc <br>
                    <strong>Phone:</strong> <a href="tel:+212661120332">+212 661-120-332</a><br>
                    <strong>Email:</strong> <a href="mailto:contact@adbaja.com">contact@adbaja.com</a><br>
                  </p>
                </div>

                <div class="social-links">
                  <a href="tel:+212661120332" class="telephone"><i class="bi bi-telephone-fill"></i></a>
                  <a href="mailto:contact@adbaja.com" class="at"><i class="bi bi-at"></i></a>
                  <a href="https://www.linkedin.com/company/adbaja" class="linkedin"><i class="bi bi-linkedin"></i></a>
                </div>
    ...
    <div class="container">
      <div class="copyright">
         Copyright &copy; 2021 <strong>ADBAJA</strong>. All Rights Reserved
      </div>
      ...
      -->
        Developed by <a href="https://khalidouahabi.dev/">khalid OUAHABI</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
